 ...
 * @LastEditors: Huangjs
 * @LastEditTime: 2022-12-12 16:50:01
 * @Description: ******
 */
...
export default () => {
  ...
  const [mesh, setMesh] = useState<boolean>(true);
  useEffect(() => {
    AMapModule.init(
      Platform.select({
          ...
          latLng &&
            mapRef.current
              ...
              .then((data: any) => {
                ...
                AMapModule.queryWeatherByCity(WeatherType.LIVE, '无锡')
                  .then((v) => console.log('LIVE: ', v))
                  .catch((ee) => {
                    console.log('LIVE: ', ee.message);
                  });
                AMapModule.coordinateConvert(CoordinateType.GPS, {
                ...
                AMapModule.queryWeatherByCity(WeatherType.FORECAST, '无锡')
